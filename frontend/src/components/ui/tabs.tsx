  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "dark:group-data-[variant=default]/tabs-list:data-active:border-input dark:group-data-[variant=default]/tabs-list:data-active:bg-input/30 dark:text-muted-foreground dark:hover:text-foreground",
